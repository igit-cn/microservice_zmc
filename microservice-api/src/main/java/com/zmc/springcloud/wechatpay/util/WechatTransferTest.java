package com.zmc.springcloud.wechatpay.util;
...
public class WechatTransferTest {
    ...
    public static Map<String, String> transfer(String openid, String re_user_name, String partner_trade_no, String amount, String desc) {
        ...
        try {
            ...
            String mch_appid = "wx6d6fd71af24c22c3"; // appid
            String mchid = "1402091802"; //
            String key = "SWCzyc20161021SWCzyc20161021aaaa"; // key
