...
public class CommonSequenceServiceImpl implements CommonSequenceService{
    ...
    @Override
    public Long getValue(CommonSequence.SequenceTypeEnum sequenceTypeEnum) throws Exception {
        return commmonSequenceMapper.findValueByType(sequenceTypeEnum.ordinal());
    }

    @Override
    public void updateValue(CommonSequence.SequenceTypeEnum sequenceTypeEnum, Long newValue)throws Exception {
