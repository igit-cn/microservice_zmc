...
import com.zmc.springcloud.wechatpay.util.HttpUtil;
import com.zmc.springcloud.wechatpay.util.MD5;
...
public class WechatPayMainOffcialAccount {
    ...
    private static void genPayReq(int type) throws Exception{
    	if(type==1) {
    ...
    /**
     生成签名
     */
    private static String getPackageSign(List<NameValuePair> params) throws Exception{
